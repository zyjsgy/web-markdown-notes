      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 flex overflow-hidden">
          {(viewMode === 'split' || viewMode === 'editor') && (
            <div className={cn(
              ...
              <textarea
                ...
                className={cn(
                  "flex-1 p-4 sm:p-6 md:p-10 resize-none focus:outline-none font-mono text-xs sm:text-sm md:text-base leading-relaxed text-claude-text/90 dark:text-claude-dark-text/90 bg-transparent",
          ...
          {(viewMode === 'split' || viewMode === 'preview') && (
            <div 
              ref={previewRef}
              className="flex-1 overflow-y-auto bg-claude-bg dark:bg-claude-dark-bg p-4 sm:p-6 md:p-10"
            >
              <div className="max-w-3xl mx-auto markdown-body text-sm md:text-base [&_h1]:text-3xl md:[&_h1]:text-4xl [&_h1]:font-serif [&_h1]:font-bold [&_h1]:mb-6 md:[&_h1]:mb-8 [&_h1]:text-claude-text dark:[&_h1]:text-white [&_h2]:text-2xl md:[&_h2]:text-3xl [&_h2]:font-serif [&_h2]:font-bold [&_h2]:mt-10 md:[&_h2]:mt-12 [&_h2]:mb-4 md:[&_h2]:mb-6 [&_h2]:text-claude-text dark:[&_h2]:text-white [&_h3]:text-xl md:[&_h3]:text-2xl [&_h3]:font-serif [&_h3]:font-bold [&_h3]:mt-6 md:[&_h3]:mt-8 [&_h3]:mb-3 md:[&_h3]:mb-4 [&_h3]:text-claude-text dark:[&_h3]:text-white [&_p]:leading-relaxed [&_p]:my-4 md:[&_p]:my-5 [&_p]:text-claude-text/90 dark:[&_p]:text-claude-dark-text/90 [&_a]:text-claude-accent [&_a]:underline [&_a]:underline-offset-4 [&_img]:rounded-2xl md:[&_img]:rounded-3xl [&_img]:my-6 md:[&_img]:my-8 [&_img]:shadow-md [&_blockquote]:border-l-4 [&_blockquote]:border-claude-accent [&_blockquote]:pl-4 md:[&_blockquote]:pl-6 [&_blockquote]:italic [&_blockquote]:text-claude-text/70 dark:[&_blockquote]:text-claude-dark-text/70 [&_blockquote]:my-4 md:[&_blockquote]:my-6 [&_table]:w-full [&_table]:border-collapse [&_table]:my-6 md:[&_table]:my-8 [&_th]:border-b-2 [&_th]:border-claude-border dark:[&_th]:border-claude-dark-border [&_th]:p-2 md:[&_th]:p-3 [&_th]:text-left [&_th]:bg-claude-sidebar/50 dark:[&_th]:bg-claude-dark-sidebar/50 [&_td]:border-b [&_td]:border-claude-border dark:[&_td]:border-claude-dark-border [&_td]:p-2 md:[&_td]:p-3 [&_ul]:list-disc [&_ul]:pl-6 md:[&_ul]:pl-8 [&_ul]:my-4 md:[&_ul]:my-5 [&_ol]:list-decimal [&_ol]:pl-6 md:[&_ol]:pl-8 [&_ol]:my-4 md:[&_ol]:my-5 [&_li]:my-1 md:[&_li]:my-2 [&_strong]:font-bold [&_em]:italic [&_code]:font-mono [&_code]:text-xs md:[&_code]:text-sm [&_code]:bg-claude-sidebar dark:[&_code]:bg-claude-dark-sidebar [&_code]:px-1.5 md:[&_code]:px-2 [&_code]:py-0.5 [&_code]:rounded-md md:[&_code]:rounded-lg">
                <Markdown 
